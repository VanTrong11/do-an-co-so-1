...
namespace ClothesShop.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public string EmailOrAccountName { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(Input.EmailOrAccountName, Input.Password, Input.RememberMe, lockoutOnFailure: false);

                if (!result.Succeeded) { 
                    var user = await _userManager.FindByEmailAsync(Input.EmailOrAccountName);
                    if (user != null)
                    {
